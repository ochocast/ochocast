import { UpdateEventUsecase } from 'src/events/domain/usecases/updateEvent.usecase';
...
describe('UpdateEventUsecase', () => {
  ...
  it('should update the event when user is authorized', async () => {
    ...
    expect(result).toEqual(eventUpdated);
  });
  ...
  /*
    Error case : Current user does not have the right to update the event 
   */
