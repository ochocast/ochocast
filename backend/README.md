...
OCTOcast backend is built with NestJS, a progressive Node.js framework for building efficient, reliable and scalable server-side applications.
...
The backend architecture of OCTOcast is organized around the Hexagonal Architecture principles.
