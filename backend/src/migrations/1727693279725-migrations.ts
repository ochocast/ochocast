...
export class Migrations1727693279725 implements MigrationInterface {
    name = 'Migrations1727693279725'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comment_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "creatorId" uuid, "videoId" uuid, CONSTRAINT "PK_5a439a16c76d63e046765cdb84f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "track_entity" ADD CONSTRAINT "FK_f1308848a9fa6de1cbdf126d481" FOREIGN KEY ("eventId") REFERENCES "event_entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "event_entity" ADD CONSTRAINT "FK_231f5952ff53137afece03849eb" FOREIGN KEY ("creatorId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "event_entity" DROP CONSTRAINT "FK_231f5952ff53137afece03849eb"`);
        await queryRunner.query(`ALTER TABLE "track_entity" DROP CONSTRAINT "FK_f1308848a9fa6de1cbdf126d481"`);
