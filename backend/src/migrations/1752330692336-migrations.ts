...
export class Migrations1752330692336 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_event_entity_tags_event" ON "event_entity_tags_tag_entity" ("eventEntityId")`);
        await queryRunner.query(`CREATE INDEX "IDX_event_entity_tags_tag" ON "event_entity_tags_tag_entity" ("tagEntityId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "event_entity_tags_tag_entity" DROP CONSTRAINT "FK_event_entity_tags_tag"`);
        await queryRunner.query(`ALTER TABLE "event_entity_tags_tag_entity" DROP CONSTRAINT "FK_event_entity_tags_event"`);
        ...
        await queryRunner.query(`ALTER TABLE "event_entity" ADD "tags" text array NOT NULL DEFAULT '{}'`);
    }
