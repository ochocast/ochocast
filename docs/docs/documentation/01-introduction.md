...
If you want the detailed step of installation you can see this ../README.md.

## Installation
Please refer to this page ... to make your first steps to contributing to the project

## Scaleway infrastructure

../images/infra_scaleway.png

## Frontend

Static website in Object Storage, to serve the front end via the Scaleway CDN (Content Delivery Network).

See more on this ../frontend/README.md.
...
See more on this ../backend/README.md.
...
See more on this ../database/README.md.
...
See more about authentification on this ../localKeycloak/README.md.
...
../images/current_branch_flow.png

# CI/CD

../images/CI_CD.png
See more on this ./workflows/README.md.
