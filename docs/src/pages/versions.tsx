...
import versionStyles from './versions.module.css';
...
export default function Versions(): JSX.Element {
  return (
    <Layout
      ...
      description="Historique des versions du projet OchoCast">
      <main className={styles.main}>
        <div className={styles.container}>
          <div className={styles.content}>
            <h1 className={styles.title}>Dernières versions</h1>
              ...
              <div className={versionStyles.versionBlock}>
                <div className={versionStyles.versionHeader}>
                  <h2 className={versionStyles.versionTitle}>
                    <span className={versionStyles.versionDate}>10 Octobre 2025</span>
                ...
                <div className={versionStyles.changelogSection}>
                  <p className={styles.text}>
                    Nouvelle version d'OchoCast développée par les équipes SIGL 2025-2026.
                  </p>
                </div>
              </div>
            </section>
