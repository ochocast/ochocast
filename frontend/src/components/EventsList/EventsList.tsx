        ...
        <div className="events-list">
            ...
            <div className="list">
                <div className="left-arrow">
                    <img className="arrow" src={leftButton} alt='Button' onClick={() => onArrowClick(false)}></img>
                </div>
                <div className="event-container">
                    {eventsShown.map((event, index) => (
                        <EventBox eventStatus={eventStatus} key={index} name={event.name} date={event.startDate} imageURL='noImage.png'
                        createdBy={!!event.creator?.firstName ? event.creator.firstName : 'Swann'} category={event.category}/>
                    ))}
                </div>
                <div className="right-arrow">
                    <img className="arrow" src={rightButton} alt='Button' onClick={() => onArrowClick(true)}></img>
                </div>
            </div>
        </div>
    )
